...
## Potential FastAPI Endpoints (THESE ARE NOT FINAL, GO TO [HERE](https://github.com/openpawks/sublimate/blob/main/docs/backend/endpoints.md) FOR CURRENT, EXPLICIT PLANS)
