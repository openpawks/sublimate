...
class TestAgentService:
    ...
    async def test_get_agent_by_id_not_found(self, agent_service, async_session):
        ...
        result = await agent_service.get_agent_by_id(9999, async_session)
    ...
    async def test_get_agents_by_project(
        ...
        result = await agent_service.get_agents_by_project(
    ...
    async def test_update_agent(self, agent_service, async_session, test_agent):
        ...
        result = await agent_service.update_agent(
            test_agent.id, agent_update, async_session
        )
    ...
    async def test_update_agent_not_found(self, agent_service, async_session):
        ...
        result = await agent_service.update_agent(9999, agent_update, async_session)
        assert result is None
    ...
    async def test_delete_agent(self, agent_service, async_session, test_agent):
        ...
        # Delete the agent
        delete_result = await agent_service.delete_agent(test_agent.id, async_session)
    ...
    async def test_delete_agent_not_found(self, agent_service, async_session):
        ...
        result = await agent_service.delete_agent(9999, async_session)
    ...
    async def test_agent_memory_cache(self, agent_service, async_session, test_agent):
        ...
        result1 = await agent_service.get_agent_by_id(test_agent.id, async_session)
