...
- TaskUpdate
- TaskResponse
- ChatResponse OR `list[MessageResponse]`
...
- `list[str]`
- for /project/{project_id}/agent_states not sure on what that schema should be.
- AgentCreate
- AgentResponse
- AgentHeartbeatCreate
- AgentHeartbeatUpdate
...
| GET | /project-templates/{template_id} | view template | NO |
| GET | /agent-templates/{agent_template_id} | view template | NO |
